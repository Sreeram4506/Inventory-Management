...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-card p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md bg-muted/50 backdrop-blur-xl border-border shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] animate-in fade-in zoom-in duration-700 relative z-10">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-5">
            <div className="space-y-2">
              ...
              <Input 
                ...
                className="bg-card/50 border-border/50 text-foreground placeholder:text-muted-foreground focus:border-profit/50 focus:ring-profit/20 h-11 transition-all" 
                value={email}
            ...
            <div className="space-y-2">
              ...
              <Input 
                id="password" 
                type="password" 
                className="bg-card/50 border-border/50 text-foreground focus:border-profit/50 focus:ring-profit/20 h-11 transition-all" 
                value={password}
          ...
          <CardFooter className="pt-4 flex flex-col gap-4">
            <Button 
              type="submit" 
              className="w-full bg-profit hover:bg-profit/90 text-primary-foreground font-bold h-11 text-base shadow-lg shadow-profit/10 transition-all hover:scale-[1.02] active:scale-[0.98]"
              disabled={isLoading}
            >
